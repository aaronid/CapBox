<?php 
	...
	if(!empty($_POST['cat_sup'])){
		if(isset($_POST['options'])){
			...
			for($i=0;$i<$count;$i++){
				$req_del="DELETE FROM catalogue WHERE _ID='".$_POST['options'][$i]."';";
				$query = mysql_query($req_del);
				if (!$query) {
					die (mysql_error());
				}
			}
...
<head>
	...
	<?php 
		$familleSousFamMarqueTri = mysql_query("select DISTINCT FAMILLE, SOUS_FAMILLE, MARQUE from $catalogue ORDER BY FAMILLE, SOUS_FAMILLE, MARQUE");
		$familleRef = "";
		$sousFamRef = "";
		$marqueRef = "";
...
<body>
    ...
    <div id="art-main">
                                ...
                                <div class="art-post-body">
                                  <div class="art-post-inner art-article">
                                            <h2 class="art-postheader">
                                                ...
                                                Administration - Consulter et gérer les articles de votre catalogue</h2>
      ...
      <tr>
        <td height="32" background="images/fd_nav_ss_menu.png" bgcolor="#F0F0F0"><a href="admin_catalogue.php"><img src="images/icones/panier-ajouter-icone-7116-32.png" width="24" height="24" align="absmiddle" /> <strong>Créer un nouvel article</strong></a><!--  <img src="images/menuseparator.png" width="1" height="24" align="absmiddle" /> <img src="images/icones/imprimante-icone-5571-32.png" width="24" height="24" align="absmiddle" /> <a href="admin_catalogue_pdf.php" target="_blank"><strong>Imprimer</strong></a><--> <img src="images/menuseparator.png" width="1" height="24" align="absmiddle" />  <img src="images/icones/panier-supprimer-icone-8119-32.png" width="24" height="24" align="absmiddle" /> <a href="#" onclick="ex();"><strong>Supprimer les articles sélectionnés</strong></a></td>
      </tr>
      <tr>
        <td bgcolor="#F9F9F9">
              ...
              <div>
                  ...
                  <select name="sousFamille" id=sousFamille class="searchSelect" onchange="reloadMarqueSelect();">
		              <script>
						...
						for (i= 0; i < lesSousFamilles.length; i++) {
							...
							newChild.setAttribute( "value", lesSousFamilles[i] );
							if (lesSousFamilles[i] == '<?php echo $sousFamille; ?>') {
								newChild.setAttribute("selected", "selected");
							}	
							newChild.appendChild(document.createTextNode(lesSousFamilles[i]));
							document.getElementById("sousFamille").appendChild( newChild );
						}
                ...
                <td class="searchTD">
                  <span>Ref. Fabricant </span>
	                <input name="refFabricant" class="searchInput" ="text" id="refFabricant" title="Saisir une référence exacte" value="<?php echo $refFabricant; ?>" />
                </td>
                <td class="searchTD">
                ...
                <td>
      		        <span style="font-weight: bold">
						...
						<a href="admin_catalogue_liste.php">
            ...
            <div id="listePiece">
              ...
              <center id="tableauListe">
                ...
                <table width="100%">
                  ...
                  <tbody>
                    <tr>
                      <td width="2%" bgcolor="#5289BA" class="Style7"><div align="center" style="font-size: 11px"><span class="Style7"></span><span class="Style7"><input type="hidden" value="1" name="cat_sup"/></span></div></td>
                      <td width="5%" bgcolor="#5289BA" class="Style7"><div align="center" style="font-size: 11px"><span class="Style7">Modifier</span></div></td>
                      <td width="7%" bgcolor="#5289BA" class="Style7"><p align="center" style="font-size: 11px"><span class="Style7">Famille</span></p></td>
                      <td width="7%" bgcolor="#5289BA" class="Style7"><p align="center" style="font-size: 11px"><span class="Style7">Sous famille</span></p></td>
                      <td width="12%" bgcolor="#5289BA" class="Style7"><div align="center" style="font-size: 11px"><span class="Style7">Marque</span></div></td>
                      <td width="10%" bgcolor="#5289BA" class="Style7"><div align="center" style="font-size: 11px"><span class="Style7">Fournisseur</span></div></td>
                    ...
                    <tr>
					  ...
					  // Debug echo "select * from catalogue $quete $parametre";
                    ...
                    <tr bgcolor="<?php echo $bgcolor; ?>">
                      <td valign="top" bgcolor="<?php echo $bgcolor; ?>" >
                       <?php 
					  if(empty($result['CLIENT'])){?> <div align="center" style="font-size: 11px"><input type="checkbox" name="options[]" class="mesCoches" id="options[]" value="<?php echo $result['_ID']; ?>" />
                      </div><?php } ?></td>
                      <td valign="top"><p align="center" class="Style6 Style4" style="font-size: 11px">
					  <?php 
					  if(empty($result['CLIENT'])){?>
                      <a href="admin_catalogue.php?id=<?php echo $result['_ID']; ?>"><img src="images/icones/editer_16.png" alt="Modifier" name="imgModifier2" width="16" height="16" id="imgModifier20" title="Modifier" /></a><?php }else{ ?>
                      ...
                      <td valign="top"align="left" ><span class="Style4" style="font-size: 11px"><?php echo $result['MARQUE']; ?></span></td>
                      <td valign="top"><span class="Style4" style="font-size: 11px"> <?php echo $result['FOURNISSEUR']; ?> </span></td>
                      <td valign="top"align="left" >
                      	<span class="Style4" style="font-size: 11px"><?php echo $result['DESIGNATION']; ?>
                      	...
                      	<div id="<?php echo $toggle; ?>" class="minimized"><img src="images/blockcontentbullets.png" width="7" height="9" />
	                      	<span style="font-weight: bold">Conditionnement : </span><?php echo $result['PRIX_AU']; ?> <br/>
	                      		<img src="images/blockcontentbullets.png" width="7" height="9" />
	                      	<span style="font-weight: bold">Prix de vente public</span> : <?php echo  number_format($result['PRIX_BASE'], 2, ',', ' '); ?> € <br/>
	                      	<img src="images/blockcontentbullets.png" width="7" height="9" />
	                      	<span style="font-weight: bold">Ref interne</span> : <?php echo $result['_ID']; ?>
	                        <p align="right">
	                        	<a href="javascript:;" onclick="toggle(<?php echo $toggle; ?>);">
                      ...
                      <td valign="top"align="right" ><div align="center" class="Style4" style="font-size: 11px"><?php 
