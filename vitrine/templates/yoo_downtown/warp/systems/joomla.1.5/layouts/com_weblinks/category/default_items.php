...
<form action="<?php echo JFilterOutput::ampReplace($this->action); ?>" method="post" name="adminForm">
	...
	<table class="zebra" border="0" cellspacing="0" cellpadding="0">
		...
		<thead>
			<tr>
				<th width="5%" align="right"><?php echo JText::_(''); ?></th>
				
				<th align="left"><?php echo JHTML::_('grid.sort',  'Informations', 'title', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>
				
				<?php if ( $this->params->get( 'show_link_hits' ) ) : ?>
				<th width="5%" align="right"><?php echo JHTML::_('grid.sort',  'Nombre de clics', 'hits', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>
				<?php endif; ?>
