...
class SearchViewSearch extends JView
{
	function display($tpl = null)
	{
		...
		// built select lists
		$orders = array();
		$orders[] = JHTML::_('select.option',  'newest', JText::_( 'Plus récent' ) );
		$orders[] = JHTML::_('select.option',  'oldest', JText::_( 'Plus ancien' ) );
		$orders[] = JHTML::_('select.option',  'popular', JText::_( 'Plus populaire' ) );
		$orders[] = JHTML::_('select.option',  'alpha', JText::_( 'Par ordre alphabétique' ) );
		$orders[] = JHTML::_('select.option',  'category', JText::_( 'Par Section/Categorie' ) );

		$lists = array();
		$lists['ordering'] = JHTML::_('select.genericlist',   $orders, 'ordering', 'class="inputbox"', 'value', 'text', $state->get('ordering') );

		$searchphrases 		= array();
		$searchphrases[] 	= JHTML::_('select.option',  'all', JText::_( 'Tous les mots' ) );
		$searchphrases[] 	= JHTML::_('select.option',  'any', JText::_( 'Un de ces mots' ) );
		$searchphrases[] 	= JHTML::_('select.option',  'exact', JText::_( 'la phrase exacte' ) );
