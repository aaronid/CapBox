...
class GalleryWidgetkitHelper extends WidgetkitHelper {
	...
	*/
	public function site() {
		...
		$this['asset']->addFile('css','gallery:css/gallery.css');
		$this['asset']->addFile('js', 'widgetkit:js/widgetkit.effects.js');
		$this['asset']->addFile('js', 'gallery:js/gallery.js');
		$this['asset']->addFile('js', 'gallery:js/slider.js');
