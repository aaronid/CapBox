...
//	var $avoirs = array();
	...
	static function calculFormule($idSociete, $dateDebPeriodeSql, $dateFinPeriodeSql, $typeMontant) {
		...
		$curentCA = Facture::getCAForThisPeriod($idSociete, $dateDebPeriodeSql, $dateFinPeriodeSql, $typeMontant);
		$lastCA = Facture::getCAForThisPeriod($idSociete, date("Y-m-d", strtotime($dateDebPeriodeSql . " - 1 year")), date("Y-m-d", strtotime($dateFinPeriodeSql . " - 1 year")), $typeMontant);
