  ...
  <tbody>
    <tr>
      <td height="32" colspan="2" background="images/fd_nav_ss_menu.png" bgcolor="#F0F0F0" class="componentheading">
          ...
          <?php
          if (!empty($idFacture) || !empty($avoir->idFacture)) {
          	 $refFacture = $avoir->idFacture;
          	 if (empty($refFacture)) {
          	 	$refFacture = $idFacture;
          	 }
          ?>
          <img src="images/menuseparator.png" width="1" height="24" />
          <a href="facture.php?<?php echo "id=" . $refFacture; ?>"><img src="images/icones/pieces-de-monnaie-icone-6896-32.png" width="24" height="24" />Retour à la facture</a>
          <?php
          }
          ?>
          </span>
