...
// récupérations des données des formulaires de tableau.php
                                    ...
                                    <div class="art-postcontent">
                                        ...
                                        <!--startprint--><table width="100%" border="0" cellpadding="0" cellspacing="0" class="art-article">
                                            ...
                                            <tr >
                                                ...
                                                <td align="center" width="9%" ><?php $rurl="/acompte_liste.php"; urld($rurl); ?><img src="images/icones/police-icone-9426-32.png" align="center" width="32" height="32" /><br />
                                                    Acomptes<?php echo $fin_url; ?>
                                                </td>
                                                <td align="center" width="9%" ><?php $rurl="/avoir_liste.php"; urld($rurl); ?><img src="images/icones/police-icone-9426-32.png" align="center" width="32" height="32" /><br />
                                                    Avoirs<?php echo $fin_url; ?>
                                                </td>
                                                <td align="center" width="9%" ><?php $rurl="/bon_liste.php"; urld($rurl); ?><img src="images/icones/blanc-page-de-pile-icone-6477-32.png" align="center"  width="32" height="32" /><br />
                                                        ...
                                                        <table width="100%" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <div>
                                                                        <br/>
                                                                        <h1><b><?php echo "Le CA de " . Facture::getCAForThisPeriod($societeContact->societe->id, $dateDebPeriodeSql, $dateFinPeriodeSql, $typeMontant) . "€ pour cette période est de " . Facture::calculFormule($societeContact->societe->id, $dateDebPeriodeSql, $dateFinPeriodeSql, $typeMontant) . "% par rapport à l'exercice précédent à période équivalente."; ?></b></h1>
                                                                    </div>
                                                                    <!--      		<div>
      			<br/>
