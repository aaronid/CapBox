...
<body>
	...
	<div id="art-main">
		...
		<?php
			...
			$fselect = mysql_query("select DISTINCT a.FACTURE from avoir a where a.ID_SOCIETE = " . $societeContact->societe->id . " AND a.FACTURE IS NOT NULL");
			while ($fresul = mysql_fetch_array($fselect)) {
				...
				echo "<option value=\"" . $fresul['FACTURE'] . "\" $selected>" . $fresul['FACTURE'] . "</option>";
			}
		?>
																	  </select>
													                </td>
			...
			?> </span></td>
																								...
																								<td><span style="font-size: 11px"> <?php echo $avoir->idFacture; ?> 
																								</span></td>
																								<!-- Tier  -->
