...
<!-- 																			<a href="acompte.php">
 ...
 -->																			<a href="<?php echo"$url&print=1"; ?>">
		...
		<?php
			...
			$fselect = mysql_query("select DISTINCT a.FACTURE from acompte a where a.ID_SOCIETE = " . $societeContact->societe->id . " AND a.FACTURE IS NOT NULL");
		...
		?>
			...
			?> </span></td>
																								...
																								<td><span style="font-size: 11px"> <?php echo $acompte->idFacture; ?> 
																								</span></td>
																								<!-- Tier  -->
