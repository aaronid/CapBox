...
<?
if(empty($catalogue)){ 
	$marquetri=mysql_query("(select DISTINCT(FAMILLE), MARQUE  from catalogue) UNION (select DISTINCT(FAMILLE), MARQUE  from cataloguep) ORDER BY FAMILLE");
}else{
...
if(empty($catalogue)){ 
	$marquetri=mysql_query("(select DISTINCT MARQUE from catalogue) UNION (select DISTINCT MARQUE from cataloguep) ORDER BY MARQUE");
}else{
      ...
      <tr>
        <td bgcolor="#F9F9F9"><!-- Periode de recherche -->
            ...
            <form action="" method="get" name="frm1" id="frm1"><div>
                ...
                <h2><strong>                  Rechercher et comparer parmi tous les articles du catalogue</strong>
...
?>
 ...
 <? } ?>
              ...
              <strong>Ref. Fabricant</strong>
                ...
                <input name="designation" type="text" id="DateDebut5" title="Saisir le texte d'une désignation produit" size="20" value="<? echo $designation; ?>" />
                ...
                <table width="100%">
                  ...
                  <tbody>
                    ...
                    <tr bgcolor="<? echo $bgcolor; ?>">
					  ...
					  $des=addslashes(str_replace("\r\n", "",$result[DESIGNATION]))." ref : ".addslashes($result[REFERENCE]);
					  	  $prixvente=$result[PRIX_NET];
					   
					  
					  echo $bgcolor; ?>" ><div align="center"><a href="#"<? echo" onclick=\"opener.document.getElementById('designation$pop').value='$des'; opener.document.getElementById('quant$pop').value='1';opener.document.getElementById('Hquant$pop').value='1';opener.document.getElementById('prix$pop').value='$prixvente';opener.document.getElementById('Hprix$pop').value='$prixvente';opener.window.calcul('t',$pop); window.close()\";" ?> ><img src="images/icones/panier-ajouter-icone-7116-32.png" width="24" height="24" align="absmiddle" title="insérer l'article au document en cours" /></a></div></td>
                    ...
                    <? $toggle++; } ?>
                    <tr>
                      <td colspan="7" bgcolor="#EAF0F7" >&nbsp;</td>
                      </tr>
