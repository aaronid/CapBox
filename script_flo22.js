...
Cell.style.backgroundColor='#EAF0F7';
  Cell.innerHTML = "<div align=center><a href=\"#\" onclick=\"window.open('catalogue_liste_pop2.php?pop="+compteur+"','','scrollbars=yes,resizable=yes,width=825,height=600')\" ><img src=images/icones/panier-ajouter-icone-7116-32.png width=32 height=32 /></a></div>";
